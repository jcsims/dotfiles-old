(custom-set-variables
 ...
 '(cider-jdk-src-paths
   (quote
    ("~/code/clojure" "/usr/lib/jvm/java-8-openjdk/src.zip")))
 '(custom-safe-themes
   (quote
