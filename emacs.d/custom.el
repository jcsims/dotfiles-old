(custom-set-variables
 ...
 '(cider-auto-jump-to-error 'errors-only t)
 '(cider-jdk-src-paths
   '("~/code/clojure-sources" "/usr/lib/jvm/java-11-openjdk/lib/src.zip") t nil "Customized with use-package cider")
 '(cider-repl-print-length nil t)
 '(cider-repl-use-pretty-printing t t nil "Customized with use-package cider")
 '(cider-save-file-on-load t t nil "Customized with use-package cider")
 '(custom-safe-themes
 ...
 '(flycheck-global-modes '(not org-mode) nil nil "Customized with use-package flycheck")
 '(groovy-indent-offset 2)
 '(json-reformat:indent-width 2)
 '(magit-branch-adjust-remote-upstream-alist '(("upstream/master" . "issue-")) t)
 '(magit-branch-prefer-remote-upstream t t)
 '(magit-save-repository-buffers 'dontask t)
 '(nrepl-use-ssh-fallback-for-remote-hosts t t)
