# add "export PROJECT_PATHS=~/projects:~/intertrode/projects" to
# navigate quickly to your project directories with `c`'

# Stolen from
# https://github.com/Bash-it/bash-it/blob/master/plugins/available/projects.plugin.bash
